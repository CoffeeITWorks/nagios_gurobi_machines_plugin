...
setup(name='gurobi_machines_plugin',
      version=version,
      description='check gurobi machines actives for long time',
      ...
      entry_points={
          'console_scripts': [
              ...
              'gurobi_machines_plugin = gurobi.__main__:main'
          ]
      },
